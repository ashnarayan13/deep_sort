...
python deep_sort_app.py --sequence_dir=/home/ashwath/fortiss/MOT16/test/MOT16-01 --detection_file=./resources/detections/MOT16_POI_test/MOT16-01.npy --min_confidence=0.3 --nn_budget=100 --display=True
